...
def get_args():
    ...
    parser.add_argument(
        '--teacher_model',
        default='pretrain_vit_base_patch16_224',
        type=str,
        metavar='TEACHER_MODEL',
        help='Name of teacher model')
    parser.add_argument(
        '--teacher_ckpt', default='', help='path to teacher checkpoint')
    parser.add_argument(
        '--ct_loss_type',
        default='infoNCE',
    ...
    parser.add_argument('--shift_frames', action='store_true', default=False)
    parser.add_argument('--shift_pixel', action='store_true', default=False)
...
def get_model(args):
    ...
    if args.teacher_ckpt:
        ...
        utils.load_state_dict(teacher_model, checkpoint_model)
    ...
    model = create_model(
        ...
        with_cp=args.with_checkpoint, 
        loss_type=args.ct_loss_type,
        ct_weight=args.ct_weight,
